package com.example.timerforeggs.presentation
...
import com.example.timerforeggs.R
import com.example.timerforeggs.adapters.AdapterChooseTypeEggs
import com.example.timerforeggs.adapters.Clickable
...
class ChooseEggsType : Fragment(), Clickable {
    ...
    private lateinit var binding: ChooseEggsTypeBinding

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View {
        binding = ChooseEggsTypeBinding.inflate(inflater)
        return binding.root
    }
    ...
    private fun showTypeOfEggs() {
        val adapterChooseTypeEggs = AdapterChooseTypeEggs(this, list) //создание адаптера со слушателем нажатий
